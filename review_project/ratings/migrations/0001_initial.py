# Generated by Django 2.0.3 on 2018-04-19 13:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TimeBufferForCalc', models.IntegerField(default=604800)),
                ('TimeLimitForRatingEdits', models.IntegerField(default=172800)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Profile1', to='ratings.Profile')),
                ('user2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Profile2', to='ratings.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Work',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ratings.Profile')),
            ],
        ),
    ]
